...
class Metaclass_TargetEstimate(type):
    """Metaclass of message 'TargetEstimate'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'swarm_interfaces.msg.TargetEstimate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__target_estimate
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__target_estimate
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__target_estimate
            cls._TYPE_SUPPORT = module.type_support_msg__msg__target_estimate
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__target_estimate
...
class TargetEstimate(metaclass=Metaclass_TargetEstimate):
    """Message class 'TargetEstimate'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.ekf_converged = kwargs.get('ekf_converged', bool())
        from builtin_interfaces.msg import Time
    ...
    def __eq__(self, other):
        ...
        if any(self.covariance != other.covariance):
            return False
        if self.ekf_converged != other.ekf_converged:
            return False
    ...
    @builtins.property
    def ekf_converged(self):
        """Message field 'ekf_converged'."""
        return self._ekf_converged

    @ekf_converged.setter
    def ekf_converged(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'ekf_converged' field must be of type 'bool'"
        self._ekf_converged = value
