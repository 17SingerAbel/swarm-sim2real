...
bool swarm_interfaces__msg__sensor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_interfaces.msg._sensor_state.SensorState", full_classname_dest, 46) == 0);
  }
  swarm_interfaces__msg__SensorState * ros_message = _ros_message;
  {  // sensor_id
  ...
  {  // assigned_target_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "assigned_target_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->assigned_target_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // pos_x
...
PyObject * swarm_interfaces__msg__sensor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_interfaces.msg._sensor_state");
  ...
  {  // assigned_target_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->assigned_target_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "assigned_target_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
