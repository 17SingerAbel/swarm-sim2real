...
swarm_interfaces__msg__TargetEstimate__init(swarm_interfaces__msg__TargetEstimate * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    swarm_interfaces__msg__TargetEstimate__fini(msg);
    return false;
  }
  return true;
}
...
swarm_interfaces__msg__TargetEstimate__are_equal(const swarm_interfaces__msg__TargetEstimate * lhs, const swarm_interfaces__msg__TargetEstimate * rhs)
{
  ...
  // ekf_converged
  if (lhs->ekf_converged != rhs->ekf_converged) {
    return false;
  }
  // stamp
  ...
  swarm_interfaces__msg__TargetEstimate * output)
{
  ...
  // ekf_converged
  output->ekf_converged = input->ekf_converged;
  // stamp
...
swarm_interfaces__msg__TargetEstimate__create()
{
  ...
  swarm_interfaces__msg__TargetEstimate * msg = (swarm_interfaces__msg__TargetEstimate *)allocator.allocate(sizeof(swarm_interfaces__msg__TargetEstimate), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(swarm_interfaces__msg__TargetEstimate));
  bool success = swarm_interfaces__msg__TargetEstimate__init(msg);
  if (!success) {
...
swarm_interfaces__msg__TargetEstimate__Sequence__init(swarm_interfaces__msg__TargetEstimate__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarm_interfaces__msg__TargetEstimate * data = NULL;

  if (size) {
    data = (swarm_interfaces__msg__TargetEstimate *)allocator.zero_allocate(size, sizeof(swarm_interfaces__msg__TargetEstimate), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = swarm_interfaces__msg__TargetEstimate__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        swarm_interfaces__msg__TargetEstimate__fini(&data[i - 1]);
      }
...
swarm_interfaces__msg__TargetEstimate__Sequence__fini(swarm_interfaces__msg__TargetEstimate__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      swarm_interfaces__msg__TargetEstimate__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  swarm_interfaces__msg__TargetEstimate__Sequence * array = (swarm_interfaces__msg__TargetEstimate__Sequence *)allocator.allocate(sizeof(swarm_interfaces__msg__TargetEstimate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = swarm_interfaces__msg__TargetEstimate__Sequence__init(array, size);
  if (!success) {
...
swarm_interfaces__msg__TargetEstimate__Sequence__destroy(swarm_interfaces__msg__TargetEstimate__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    swarm_interfaces__msg__TargetEstimate__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
swarm_interfaces__msg__TargetEstimate__Sequence__are_equal(const swarm_interfaces__msg__TargetEstimate__Sequence * lhs, const swarm_interfaces__msg__TargetEstimate__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!swarm_interfaces__msg__TargetEstimate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  swarm_interfaces__msg__TargetEstimate__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(swarm_interfaces__msg__TargetEstimate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    swarm_interfaces__msg__TargetEstimate * data =
      (swarm_interfaces__msg__TargetEstimate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!swarm_interfaces__msg__TargetEstimate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          swarm_interfaces__msg__TargetEstimate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!swarm_interfaces__msg__TargetEstimate__copy(
