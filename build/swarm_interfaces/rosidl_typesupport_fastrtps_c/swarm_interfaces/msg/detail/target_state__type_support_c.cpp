...
#include "swarm_interfaces/msg/detail/target_state__rosidl_typesupport_fastrtps_c.h"
...
using _TargetState__ros_msg_type = swarm_interfaces__msg__TargetState;
...
size_t get_serialized_size_swarm_interfaces__msg__TargetState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetState__ros_msg_type * ros_message = static_cast<const _TargetState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TargetState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_swarm_interfaces__msg__TargetState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_swarm_interfaces
size_t max_serialized_size_swarm_interfaces__msg__TargetState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces__msg__TargetState;
    is_plain =
      (
...
static size_t _TargetState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_swarm_interfaces__msg__TargetState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swarm_interfaces, msg, TargetState)() {
