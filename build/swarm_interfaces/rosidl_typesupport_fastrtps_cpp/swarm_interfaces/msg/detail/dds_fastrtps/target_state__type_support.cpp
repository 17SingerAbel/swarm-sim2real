...
#include "swarm_interfaces/msg/detail/target_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const swarm_interfaces::msg::TargetState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  swarm_interfaces::msg::TargetState & ros_message)
{
  // Member: target_id
  cdr >> ros_message.target_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces::msg::TargetState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swarm_interfaces::msg::TargetState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_interfaces::msg::TargetState *>(
    untyped_ros_message);
...
{
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_TargetState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, swarm_interfaces, msg, TargetState)() {
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_TargetState__handle;
}
